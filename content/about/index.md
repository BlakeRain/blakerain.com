...
If you need to get in touch with me, you can either use <a href=mailto:blake.rain@blakerain.com>email</a> or DM me on [Mastodon].

- {{ icon("bootstrap", "envelope-at") }} Email: <a href=mailto:blake.rain@blakerain.com>blake.rain@blakerain.com</a>
- {{ icon("bootstrap", "mastodon", color="#6364FF") }} Mastodon: https://mastodonapp.uk/@BlakeRain
- {{ icon("bootstrap", "linkedin", color="#0A66C2") }} LinkedIn: https://www.linkedin.com/in/blakerain
