...
![Blender showing it's Transform overlay on the right, within the 3D view](/content/overlays-with-custom-widgets-in-gtk/image.png)
...
![Showing the main window with no content](/content/overlays-with-custom-widgets-in-gtk/image-2.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-3.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-4.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-5.png)
...
![The major and minor grid lines](/content/overlays-with-custom-widgets-in-gtk/image-6.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/recording1.gif)
...
![](/content/overlays-with-custom-widgets-in-gtk/recording2.gif)
...
![A ControlPanelGroup with some controls](/content/overlays-with-custom-widgets-in-gtk/image-7.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-8.png)
...
![Various <code>halign</code> and <code>valign</code> options and their effects on overlay placement](/content/overlays-with-custom-widgets-in-gtk/image-9.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/Peek-2021-01-14-20-14.gif)
...
![](/content/overlays-with-custom-widgets-in-gtk/Peek-2021-01-14-20-18.gif)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-10-1.png)

We can now navigate through the object tree until we get to our `MyControlPanel` widget.

![](/content/overlays-with-custom-widgets-in-gtk/image-11-1.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-12.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-13.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-14.png)

Click the `+` button in the `Style Classes` popover to add a new class, and enter the name `control-panel`.

![](/content/overlays-with-custom-widgets-in-gtk/image_o-15.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-16.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-18.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-19.png)

Looking closely at the bottom-left corner of the control panel, we can see quite a sharp corner:

![](/content/overlays-with-custom-widgets-in-gtk/image-20.png)
...
![](/content/overlays-with-custom-widgets-in-gtk/image-22.png)
