...
- [Bitwarden] - My other password manager. [{{ icon("bootstrap", "github") }}](https://github.com/bitwarden)
...
- [HammerSpoon] - Utility for automating MacOS, useful for emulating some of the features I miss
  ...
  days. [{{ icon("bootstrap", "github") }}](https://github.com/Hammerspoon/hammerspoon)
- [LibreOffice] - A great open-source office suite.
- [Mona] - iOS client for [Mastodon].
- [Navidrome] - A self-hosted music server. I use this instead of Spotify or Apple Music. [{{ icon("bootstrap", "github") }}](https://github.com/navidrome/navidrome/)
- [NetNewsWire] - An RSS reader for iOS and macOS. [{{ icon("bootstrap", "github") }}](https://github.com/Ranchero-Software/NetNewsWire)
...
- [SearXNG] - A self-hosted search engine. Used as my default on all devices where I have a choice.
  [{{ icon("bootstrap", "github") }}](https://github.com/searxng/searxng/tree/master)
- [Syncthing]  - For syncing files between devices. [{{ icon("bootstrap", "github") }}](https://github.com/syncthing/syncthing)
- [Thunderbird] - A FOSS email client. [hg](https://hg-edge.mozilla.org/comm-central/)
- [Zotero] - A tool for managing your research library. [{{ icon("bootstrap", "github") }}](https://github.com/zotero/zotero)
...
- [Blog Quest] - Silently collects RSS feeds as you browse the internet.
  [{{ icon("bootstrap", "github") }}](https://github.com/robalexdev/blog-quest).
- [Linkding Extension] - Companion extension to [Linkding](https://linkding.link/).
  [{{ icon("bootstrap", "github") }}](https://github.com/sissbruecker/linkding-extension/)
- [Dark Reader] - Dark mode for Firefox.
  [{{ icon("bootstrap", "github") }}](https://github.com/darkreader/darkreader)
- [Mastodon Redirector] - Redirects Mastodon links to a Mastadon instance of your choice, saving you
  ...
  [{{ icon("bootstrap", "github") }}](https://github.com/bramus/mastodon-redirector)
...
- [StreetPass] - Monitors sites that you visit and silently collects Mastodon profiles.
  [{{ icon("bootstrap", "github") }}](https://github.com/tvler/streetpass)
- [uBlock Origin] - A well-known content blocker for Firefox.
- [Vimium] - Adds Vim-like key bindings to Firefox.
  [{{ icon("bootstrap", "github") }}](https://github.com/philc/vimium)
