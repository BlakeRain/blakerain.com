...
{% call callout("note", "Raspberry Pi Boot Delays") %}
...
{% call callout("warning", "Faulty Hardware") %}
...
{% call callout("tip", "Forwarding for IPv6") %}
...
{% from "macros/callout.html" import callout %}
{% call callout("question", "RFC8375 would be better") %}
