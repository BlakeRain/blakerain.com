...
Searching for occurrences from this node, the first leaf we reach is for the word `"ben"` which has
...
Once the search data has been built and the file has been generated, the GitHub action uploads the
