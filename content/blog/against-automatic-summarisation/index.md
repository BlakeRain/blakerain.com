...
I've been thinking about the issues that I've experienced with LLMs summarising content and missing
what I've found to be significant components of the content, and in some cases, outright
misrepresenting it. I'm starting to believe that, contrary to what I've often been told, LLMs are
not effective summarisers.

<!--more-->

A while ago I read [The Timmy Trap] by Scott Jenson. I liked how Jenson demonstrates the
anthropomorphizing of LLMs. One thing that he said that stuck with me was that LLMs _shorten_ rather
than _summarise_.
...
Jenson then goes on to discuss this in more detail, using the film The Matrix as an example. Where I
think I've seen the most impact of this is in the appreciation of published research and articles.
I've seen a few people use LLMs to summarise articles or papers, sometimes even in aggregate.
Putting aside the problem of hallucination for now, I think there are two issues with relying on
summaries of detailed and technical content, regardless of whether the summaries are generated by
language models or not.
...
1. I think the details often matter a lot more than the outcome. After all, we don't often publish
   ...
   journey that the authors took to get to their conclusions. Unlocking further understanding by
   reproducing findings would be nearly impossible with just a summary.
1. Publications may often contain structural elements that are important to the comprehension of the
   document, and that might be elided during summarisation. Key features of an publication might be
   found in the subtext or understructure of the publication, rather than the surface content. For
   example, an author might choose to defend one aspect more than another. There may be asymmetries
   in the care and attention given to different sections of the publication. Tonal shifts can be
   missed. Text summarisation models may be trained to optimise for what is said, rather than why
   and how.

I think when we summarise, especially using a language model, we should be more aware of what we are
losing. When I read something, I often find that some of the most impactful lessons are within the
body of the publication.

A recent example I encountered was a paper called [Behind the Headline Number: Why Not to Rely on
...
employment: How susceptible are jobs to computerisation?]. The abstract summarises the findings of
the paper with the following sentence:
...
me. Not only did I understand a lot more about why the authors felt the Frey-Osborne predictions
might be flawed, but I was moved by the possibility and its implications. In this way, the
conclusion of the paper -- the re-framed credibility of the Frey-Osborne results -- was actually
less useful to me than the lesson to be suspicious of distributional stories that might just be
model artefacts.
...
an AI summary of the paper that was generated for me:
...
{{< figure src="arxivlens-misrepresenting-paper.png" title="Part of an incorrect summary of a paper" >}}
