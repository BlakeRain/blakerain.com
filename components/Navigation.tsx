...
const GitHubLink: FC = () => {
  return (
    <a href="https://github.com/BlakeRain" title="GitHub" target="_blank" rel="noreferrer">
      <svg viewBox="0 0 32 32">
...
const TwitterLink: FC = () => {
  return (
    <a href="https://twitter.com/HalfWayMan" title="Twitter" target="_blank" rel="noreferrer">
      <svg viewBox="0 0 32 32">
...
const NavigationBar: FC<SearchChildProps & { navigation: SiteNavigation[] }> = (props) => {
  return (
...
const NavigationInner: FC<SearchChildProps & { navigation: SiteNavigation[] }> = (props) => {
  return (
    <React.Fragment>
      <NavigationBar {...props} />
